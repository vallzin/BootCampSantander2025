...
public class Main {
    ...
    private static void inputNumber() {
        ...
        System.out.println("Infome a coluna em que o número será inserido");
    ...
    private static void removeNumber() {
        if (isNull(board)){
            System.out.println("O jogo aind não foi iniciado");
            return;
        }

        System.out.println("Informe a coluna em que o núero será removido");
        var col = runUntilGetValidNumber(0, 8);
